...
def modify_js():
    ...
    # 1. Provide the Enhancements function
    enhancements = """
  ...
  function initEnhancements() {
    ...
    updateHoverStates();
    // In case dynamic elements are loaded (like currently building)
    setInterval(updateHoverStates, 1000);
  }

  // Self execute inside the file if needed.
...
"""
    ...
    if "initEnhancements" not in content:
